...
var _default = createComponent({
  ...
  props: (0, _extends2.default)((0, _extends2.default)({}, _shared.cellProps), {}, {
    name: String,
    rules: Array,
    error: Boolean,
    disabled: Boolean,
  ...
  computed: {
    ...
    listeners: function listeners() {
      return (0, _extends2.default)((0, _extends2.default)({}, this.$listeners), {}, {
        blur: this.onBlur,
        focus: this.onFocus,
        input: this.onInput,
  ...
  methods: {
    ...
    genInput: function genInput() {
      ...
      var inputProps = {
        ...
        attrs: (0, _extends2.default)((0, _extends2.default)({}, this.$attrs), {}, {
          name: this.name,
